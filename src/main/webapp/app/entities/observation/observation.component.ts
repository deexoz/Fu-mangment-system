...
export class ObservationComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.observationService
      ...
      .subscribe(
        (res: HttpResponse<IObservation[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInObservations(): void {
    this.eventSubscriber = this.eventManager.subscribe('observationListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IObservation[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
