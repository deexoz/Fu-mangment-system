...
export class PhaseComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.phaseService
      ...
      .subscribe(
        (res: HttpResponse<IPhase[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInPhases(): void {
    this.eventSubscriber = this.eventManager.subscribe('phaseListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IPhase[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
