...
public class FacultyResource {
    ...
    public ResponseEntity<List<Faculty>> getAllFaculties(FacultyCriteria criteria, Pageable pageable) {
        log.debug("REST request to get Faculties by criteria: {}", criteria);
        Page<Faculty> page = facultyQueryService.findByCriteria(criteria, pageable);
