...
public class AnnouncementResourceIT {
    ...
    @Test
    @Transactional
    public void getAllAnnouncementsByAnnouncmentTypeIsEqualToSomething() throws Exception {
        // Initialize the database
        announcementRepository.saveAndFlush(announcement);

        // Get all the announcementList where announcmentType equals to DEFAULT_ANNOUNCMENT_TYPE
        defaultAnnouncementShouldBeFound("announcmentType.equals=" + DEFAULT_ANNOUNCMENT_TYPE);

        // Get all the announcementList where announcmentType equals to UPDATED_ANNOUNCMENT_TYPE
        defaultAnnouncementShouldNotBeFound("announcmentType.equals=" + UPDATED_ANNOUNCMENT_TYPE);
    }

    @Test
    @Transactional
    public void getAllAnnouncementsByAnnouncmentTypeIsNotEqualToSomething() throws Exception {
        // Initialize the database
        announcementRepository.saveAndFlush(announcement);

        // Get all the announcementList where announcmentType not equals to DEFAULT_ANNOUNCMENT_TYPE
        defaultAnnouncementShouldNotBeFound("announcmentType.notEquals=" + DEFAULT_ANNOUNCMENT_TYPE);

        // Get all the announcementList where announcmentType not equals to UPDATED_ANNOUNCMENT_TYPE
        defaultAnnouncementShouldBeFound("announcmentType.notEquals=" + UPDATED_ANNOUNCMENT_TYPE);
    }

    @Test
    @Transactional
    public void getAllAnnouncementsByAnnouncmentTypeIsInShouldWork() throws Exception {
        // Initialize the database
        announcementRepository.saveAndFlush(announcement);

        // Get all the announcementList where announcmentType in DEFAULT_ANNOUNCMENT_TYPE or UPDATED_ANNOUNCMENT_TYPE
        defaultAnnouncementShouldBeFound("announcmentType.in=" + DEFAULT_ANNOUNCMENT_TYPE + "," + UPDATED_ANNOUNCMENT_TYPE);

        // Get all the announcementList where announcmentType equals to UPDATED_ANNOUNCMENT_TYPE
        defaultAnnouncementShouldNotBeFound("announcmentType.in=" + UPDATED_ANNOUNCMENT_TYPE);
    }

    @Test
    @Transactional
    public void getAllAnnouncementsByAnnouncmentTypeIsNullOrNotNull() throws Exception {
        // Initialize the database
        announcementRepository.saveAndFlush(announcement);

        // Get all the announcementList where announcmentType is not null
        defaultAnnouncementShouldBeFound("announcmentType.specified=true");

        // Get all the announcementList where announcmentType is null
        defaultAnnouncementShouldNotBeFound("announcmentType.specified=false");
    }
