...
import { ResultDataComponent } from 'app/entities/result-data/result-data.component';
...
describe('Component Tests', () => {
  describe('ResultData Management Component', () => {
    let comp: ResultDataComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(ResultDataComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.resultData && comp.resultData[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
